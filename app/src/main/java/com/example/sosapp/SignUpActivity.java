...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_sign_up_with_google = findViewById(R.id.btn_sign_up_with_google);
        Button btn_sign_up = findViewById(R.id.btn_sign_up);

        TextInputLayout input_email = findViewById(R.id.email_text_field);
        TextInputLayout input_password = findViewById(R.id.password_text_field);
        ...
        btn_sign_up_with_google.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_sign_up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.isEmpty()){
                    ...
                    input_password.setError("Please provide a password");
